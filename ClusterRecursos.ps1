...
##VARIABLES!!
$OutputFileName	= "D:\inventario\$fecha\Datastore\cluster-Recursos.html"
...
$x=100
$porc=0
foreach ($cluster in  get-datacenter BUETY | get-cluster *WIN*  )
	{
...
#############MAIL###############
		...
		$TO="administracionwindowsserver@ypf.com"
		$Asunto="!!!!!!ESTE MES USAR EL CLUSTER PRODUCTIVO " + $dis + "!!!!!!!!!!!"
		$cuerpo="En el corriente mes realizar las creaciones de nuevas VM sobre el cluster " + $dis
