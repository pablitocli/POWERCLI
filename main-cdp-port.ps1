...
connect-viserver SSBUETYVMW11 -user ypf\ys00837 -password VcoPS3011
connect-viserver SSBUETYVMW03 -user ypf\ys00837 -password VcoPS3011
...
Write-Host "Creacion de archivos con la informacion de los hosts "
		...
		$TO="administracioncloudypf@ypf.com", "InfraestructuraCPDCentrales@ypf.com"
		$Asunto="Verificación de CONEXIONES FISICAS de la Infraestructura Virtual -  Administración Cloud YPF "
		$cuerpo="En el siguiente archivo adjunto se encuentran las conexiones fisicas de todos los nodos de la infraestructura a modo de back-up"
